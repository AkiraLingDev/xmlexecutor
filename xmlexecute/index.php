...
if(empty($sitemapUrl)){
    ...
    <div class="xml-main-preloader">Мы начали обрабатывать вашу карту сайта. Это может занять некоторое время, потерпите, пожалуйста. <img style="width: 20px;" src="/core/assets/img/preloader.gif"></div>
